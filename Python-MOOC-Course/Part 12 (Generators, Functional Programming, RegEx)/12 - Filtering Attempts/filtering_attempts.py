...
def passed_students(attempts: list, course: str):
    students_who_passed = filter(lambda attempt : attempt.course_name == course and attempt.grade > 0, attempts)
    return sorted(map(lambda student : student.student_name, students_who_passed))
